...
HEARTBEAT_DIR = PROJECT_ROOT / "tmp" / "hcc-deployment-workers"
...
def configure_django() -> None:
    ...
    settings.HCC_DEPLOYMENT_EXECUTOR_URL = DEPLOYMENT_EXECUTOR_URL
    settings.HCC_DEPLOYMENT_EXECUTOR_TIMEOUT = DEPLOYMENT_EXECUTOR_TIMEOUT_SECONDS
